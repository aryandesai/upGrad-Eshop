...
function Login() {
        ...
        return (
            ...
            <div className="loginContainer">
                ...
                <TextField label="Email Address" onChange={(e) => setEmail(e.target.value)} required variant="outlined" type="email"
                    sx={{ mb: 3 }} fullWidth value={email} error={emailError}
                />
                <TextField label="Password" onChange={(e) => setEmail(e.target.value)} required variant="outlined" type="email"
